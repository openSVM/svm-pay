...
exports.SVMPayVue = exports.QRCodePayment = exports.PaymentButton = void 0;
// Vue component for payment button
exports.PaymentButton = {
    name: 'SvmPayButton',
    props: {
    ...
    methods: {
        async handleClick() {
            try {
                ...
                const paymentUrl = this.svmPay.createTransferUrl(this.recipient, this.amount, {
    ...
    methods: {
        initializePayment() {
            try {
                ...
                this.reference = ref;
                // Create a payment URL
                const url = this.svmPay.createTransferUrl(this.recipient, this.amount, {
                    network: this.network || undefined,
                    splToken: this.token || undefined,
                    label: this.label,
                    message: this.description,
...
exports.SVMPayVue = {
    install(Vue, options = {}) {
        Vue.component('svm-pay-button', exports.PaymentButton);
        Vue.component('svm-pay-qr-code', exports.QRCodePayment);
    }
};
exports.default = exports.SVMPayVue;
